...
previous_knowledge = RetrivalQA.from_chain_type(
    llm=llm, chain_type="stuff", retriever=vectordb.as_retriever()
)

print("Creating retrival agent...")
tools = [
    Tool(
        name="Previous Therapist experience",
        func=previous_knowledge.run,
        description="I had a patient with a similar problem in the past. Here's what I said to help them.",
    )
]
agent = initialize_agent(
    tools, llm, agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION, verbose=True
)
print("Retrival agent created.")
